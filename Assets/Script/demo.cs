...
// {
//     public GameObject[] panels; // Array to hold references to all your panels
//     private Stack<GameObject> panelStack = new Stack<GameObject>(); // Stack to store navigation history
